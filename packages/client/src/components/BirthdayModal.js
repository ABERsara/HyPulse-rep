...
const styles = StyleSheet.create({
  ...
  sheet: { backgroundColor: '#1f2937', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 24 },
  title: { color: '#fff', fontSize: 18, fontWeight: 'bold', textAlign: 'center', marginBottom: 20 },
  pickerPlaceholder: { height: 120, justifyContent: 'center', alignItems: 'center', backgroundColor: '#374151', borderRadius: 8 },
  placeholderText: { color: '#6b7280' },
  btn: { backgroundColor: '#06b6d4', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 20 },
